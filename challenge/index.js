    ...
    function colorChange() {
        for (var i = 1; i <= 16; i++) {
            if (document.querySelector(".boxes" + i).innerText == i) {
                document.querySelector(".boxes" + i).style.backgroundColor = "black";
                document.querySelector(".boxes" + i).style.color = "black";

            }
            else if (document.querySelector(".boxes" + i).innerText != 0) {
                document.querySelector(".boxes" + i).style.backgroundColor = "#5F939A";
                document.querySelector(".boxes" + i).style.color = "white";
            }
            else {
                document.querySelector(".boxes" + i).style.color = "white";
            }
